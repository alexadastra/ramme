...
collect:
	...
	mv ${PATH_PREFIX}${APP}/internal/app/ramme_template.go ${PATH_PREFIX}${APP}/internal/app/service/$(shell echo ${APP} | tr '-' '_' ).go
	mv ${PATH_PREFIX}${APP}/internal/app/ramme_template_test.go ${PATH_PREFIX}${APP}/internal/app/service/$(shell echo ${APP} | tr '-' '_')_test.go
