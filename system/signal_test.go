...
func (th testHandling) Shutdown(err error) error {
	th.ch <- Shutdown
	return ErrNotImplemented
}

// Add test implementation
func (th testHandling) Add(func() error, func(error)) {}

// Run test implementation
func (th testHandling) Run() error {
	return ErrNotImplemented
}
